...
public class AltHTMLWriter extends AbstractWriter {
    ...
    protected void writeAttributes(AttributeSet attr) throws IOException {
        ...
        while (names.hasMoreElements()) {
            ...
            boolean condition1 = name instanceof HTML.Tag || name instanceof StyleConstants;
            boolean condition2 = condition1 || name == HTML.Attribute.ENDTAG;
            if (condition2) {
                continue;
            }
    ...
    protected void emptyTag(Element elem) throws BadLocationException, IOException {
        ...
        if (matchNameAttribute(attr, HTML.Tag.CONTENT)) {
            ...
            //
            boolean cond1 = nameTag != null && endTag != null;
            boolean cond2 = (endTag instanceof String) && ((String) endTag).equals("true");
